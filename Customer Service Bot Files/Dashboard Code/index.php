...
<head>
    ...
    <title>Hotel Assistant Dashboard</title>
    <!-- Favicon-->
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Hotel Assistant Dashboard</a>
            </div>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                ...
                <div class="body">
                            <p class="lead">
                                This dashboard is a portal to the customer service conversatinal agent.
                            </p>
                            <p>
                                Click on the complaints option to view complaints.
                            </p>
                            <p>
                                Click on the orders option to view the orders.
                            </p>
                        </div>
